...
- **Real hardware** (e.g. `openarm01_teleop`) — runs against the physical robot
- **Simulator-specific** (e.g. `openarm01_teleop_isaac`, `openarm01_teleop_mujoco`) — same stack wired to a simulator
